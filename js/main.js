    ...
    template: `
        <div class="product">
            ...
            <div>
                ...
                <review-search @search-reviews="searchReviews"></review-search>
            </div>
        </div>
    `,
    data() {
        return {
            ...
            inventory: 100,
            variants: [
                { variantId: 2234, variantColor: 'green', variantImage: "./assets/vmSocks-green-onWhite.jpg", variantQuantity: 10, variantSale: true },
                { variantId: 2235, variantColor: 'blue', variantImage: "./assets/vmSocks-blue-onWhite.jpg", variantQuantity: 10, variantSale: true }
            ],
...
Vue.component('product-review', {
    ...
    <form class="review-form" @submit.prevent="onSubmit">
        ...
        <p v-if="showNotification">{{ notification }}</p>
        <p>
    ...
    methods: {
            onSubmit() {
                if (this.name && this.review && this.rating && this.recommend) {
                    ...
                    this.notification = 'Ваше сообщение отправлено';
                    setTimeout(() => {
...
Vue.component('review-search', {
    template:`
        <div>
            <label for="search">Поиск отзывов:</label>
            <input id="search" v-model="searchTerm" @input="performSearch" placeholder="Введите ключевые слова">
        </div>
        `,
    data() {
        return {
    ...
    methods: {
        performSearch() {
            this.$emit('search-reviews', this.searchTerm);
        }
    }
});